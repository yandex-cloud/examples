...
#
# RU: https://cloud.yandex.ru/docs/managed-kubernetes/tutorials/fluent-bit-logging
# EN: https://cloud.yandex.com/en/docs/managed-kubernetes/tutorials/fluent-bit-logging
