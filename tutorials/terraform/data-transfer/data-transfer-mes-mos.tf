...
locals {
  ...
  source_endpoint_name  = "mes-source"             # Name of the source endpoint for MySQL cluster
  target_endpoint_name  = "mos-target"             # Name of the target endpoint for PostgreSQL cluster
